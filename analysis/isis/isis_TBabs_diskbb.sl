% NAME:
% -----
% isis_TBabs_diskbb.sl
%
% PURPOSE:
% --------
% Fit the GRO J1655-40 spectrum with the model "TBabs*diskbb" w/ nH as a free parameter.
%
% OUTPUTS: <-- To the directory /Users/salvesen/research/fcolabs/results/
% --------
% isis_TBabs_diskbb.par - Parameter file for the model fit
% isis_TBabs_diskbb.fit - Bestfit parameters and uncertainties
...
variable fpars = dout + "isis_TBabs_diskbb.par";
variable fbfit = dout + "isis_TBabs_diskbb.fit";
...
%====================================================================================================
% FIT MODEL "TBabs*diskbb" W/ nH *FREE* AND OUTPUT RESULTS
...
() = fprintf(fp, "nH       (nH_lower, nH_upper) Kbb        (Kbb_lower, Kbb_upper)  Tin      (Tin_lower, Tin_upper) chisqr     dof\n");
() = fprintf(fp, "%8.6f (%8.6f, %8.6f) %8.6f (%8.6f, %8.6f) %8.6f (%8.6f, %8.6f) %12.6f %3.0f\n",
             nH, nH_lo[0], nH_hi[0], Kbb, Kbb_lo[0], Kbb_hi[0], Tin,  Tin_lo[0],  Tin_hi[0], chisqr, dof);
() = fclose(fp);
