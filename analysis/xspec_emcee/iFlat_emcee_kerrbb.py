...
# EMCEE inputs
nwalk  = 500#100   # Number of walkers
nburn  = 1000#1000  # Number of iterations, or steps, for each walker for the burn-in
nmcmc  = 2500#1000  # Number of iterations, or steps, for each walker for the production run

# Input/Output files
ftag   = "iFlat_"
obsID  = "00030009021"
dout   = "/Users/salvesen/research/fcolabs/results/" + obsID + "/"  # Output directory
#fchi   = dout + ftag + "TBabs_kerrbb_" + ftag + obsID + ".xcm"      # Input best-fit parameters from chi^2 method
